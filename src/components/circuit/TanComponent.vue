<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="tan">
    <ComponentPins class="pins-in" :count="1" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-tan" />
      <div class="component-name">Tan</div>
    </div>
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="tan" :id="props.id">
    <div class="component-header">Tan</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="Tan Component">
