<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="ceil">
    <ComponentPins class="pins-in" :count="1" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-ceil" />
      <div class="component-name">Ceil</div>
    </div>
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="ceil" :id="props.id">
    <div class="component-header">Ceil</div>
