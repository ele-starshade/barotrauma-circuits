<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="multiply">
    <ComponentPins class="pins-in" :count="2" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-multiply" />
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="multiply" :id="props.id">
    <div class="component-header">Multiply</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="Multiply Component">
