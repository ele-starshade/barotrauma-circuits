<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="greater">
    <ComponentPins class="pins-in" :count="3" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-greater" />
      <div class="component-name">Greater</div>
    </div>
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="greater" :id="props.id">
    <div class="component-header">Greater</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="Greater Component">
