<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="factorial">
    <ComponentPins class="pins-in" :count="1" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-factorial" />
      <div class="component-name">Factorial</div>
    </div>
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="factorial" :id="props.id">
    <div class="component-header">Factorial</div>
