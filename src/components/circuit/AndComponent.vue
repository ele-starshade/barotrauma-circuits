<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="and">
    <ComponentPins class="pins-in" :count="2" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-and" />
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="and" :id="props.id">
    <div class="component-header">And</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="AND Component">
