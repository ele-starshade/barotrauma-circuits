<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="sin">
    <ComponentPins class="pins-in" :count="1" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-sin" />
      <div class="component-name">Sin</div>
    </div>
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="sin" :id="props.id">
    <div class="component-header">Sin</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="Sin Component">
