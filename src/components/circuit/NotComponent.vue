<template>
  ...
  <div v-if="mode === 'tray'" v-bind="$attrs" class="component graphical" data-component-type="not">
    <ComponentPins class="pins-in" :count="1" />

    <div class="icon-container">
      <div class="component-icon-sprite icon-not" />
  ...
  <div v-else v-bind="$attrs" class="component text-based" data-component-type="not" :id="props.id">
    <div class="component-header">Not</div>
  ...
  <Teleport to="#config-panel-container" v-if="isSelected && mode === 'board'">
    <ConfigPanel title="Not Component">
