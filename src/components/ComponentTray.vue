    ...
    <div class="components-section">
      ...
      <div class="components-grid">
        <component
          ...
          mode="tray"
          @click="onTrayComponentClick(component)"
          :class="{ 'selected-for-placement': isSelectedForPlacement(component) }"
        />
      </div>
    </div>
...
function onTrayComponentClick (component) {
  circuit.startPlacement(component)
}

function isSelectedForPlacement (component) {
  return circuit.pendingPlacementComponent && circuit.pendingPlacementComponent.name === component.name
}
