...
describe('AtanComponent', () => {
  it('renders in tray mode', () => {
    const wrapper = mountWithCircuit(AtanComponent, { props: { id: 'atan1', mode: 'tray' } })

    expect(wrapper.text()).toContain('Atan')
  ...
  it('renders in board mode and shows pins', () => {
    const wrapper = mountWithCircuit(AtanComponent, { props: { id: 'atan2', mode: 'board' } })
  ...
  it('has correct component type attribute', () => {
    const wrapper = mountWithCircuit(AtanComponent, { props: { id: 'atan3', mode: 'board' } })
